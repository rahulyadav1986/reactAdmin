...
export const AvailablityPop = () => {
  ...
  return (
    <div className={`${style.availablity_pop_wrapper} availablity_pop_wrapper`}>
        <ul>
            <li className={style.status_level}>Change your status</li>
            {
                AvailabilityData.map((item,i)=>{
                    return(
                        <li key={i} onClick={()=>{AvailabilityToggleContext.handleStatusItem(item);AvailabilityToggleContext.handleTimer('start')}}>
            ...
            <li onClick={(e)=>{AvailabilityToggleContext.handleOnCampaignClick(e),AvailabilityToggleContext.handleTimer('start')}}>
