...
import MenuNodeIcon from "/assets/dashboard/main_dashboard/admin/workflow/nodeOption/card.svg"
...
const CardNode = ({ ...data }) => {
  ...
  return (
    <div className={`${style.node_area} ${style.card} ${(contextWorkflow.selectedNodeForSetting.id == data.id) ? style.recent_node : null}`}>
