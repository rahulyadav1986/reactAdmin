...
const SupervisorAvailability = () => {
  ...
  return ( 
    <div className={style.available_main_wrapper}>
      {
        AvailabilityToggleContext.visibleStatus && 
        <div className={style.available_button_wrap}>
          <div className={style.availability_wrapper} onClick={AvailabilityToggleContext.handleStatusToggle}>
              <div className={`${style.inner_area} d-flex align-items-center justify-content-between`}>
                <span className={`${style.bell} d-flex align-items-center`}>
...

      {
        ...
        <div className={`${style.availablity_campaign_wrapper} ${style.button_two} d-flex `}>
          <div className={style.available_button_wrap}>
            <div className={style.availability_wrapper} onClick={AvailabilityToggleContext.handleStatusToggle}>
              <div className={`${style.inner_area} d-flex align-items-center justify-content-between`}>
                  <span className={`${style.bell} d-flex align-items-center`}>
          ...
          <div className={style.available_button_wrap}>
            <div className={`${style.availability_wrapper} ${style.button_campaign}`} onClick={AvailabilityToggleContext.handleCampaignToggle}>
              <div className={`${style.inner_area} d-flex align-items-center justify-content-between`}>
                  <span className={`${style.bell} d-flex align-items-center`}>
