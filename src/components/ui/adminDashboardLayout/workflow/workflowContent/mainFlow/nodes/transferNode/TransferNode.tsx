...
import TransferNodeIcon from "/assets/dashboard/main_dashboard/admin/workflow/nodeOption/transfer.svg"
...
const TransferNode = ({ ...data }) => {
  ...
  return (
    <div className={`${style.node_area} ${style.transfer} ${(contextWorkflow.selectedNodeForSetting.id == data.id) ? style.recent_node : null}`}>
      <span className={style.message}><img src={MessageIcon} alt="" /></span>
      <div className={`${style.button} d-flex align-items-center`}>
        <img src={TransferNodeIcon} alt="" />
