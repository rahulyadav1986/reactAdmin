...
import SmsIcon from "/assets/dashboard/main_dashboard/admin/workflow/nodeOption/message.svg"
...
const SmsNode = ({ ...data }) => {
  ...
  return (
    <div className={`${style.node_area} ${style.sms} ${(contextWorkflow.selectedNodeForSetting.id == data.id) ? style.recent_node : null}`}>
