...
import MenuNodeIcon from "/assets/dashboard/call.svg"
...
const VoiceNode = ({ ...data }) => {
  ...
  return (
    <div className={`${style.node_area} ${style.voice} ${(contextWorkflow.selectedNodeForSetting.id == data.id) ? style.recent_node : null}`}>
