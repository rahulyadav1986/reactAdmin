...
import MenuNodeIcon from "/assets/dashboard/main_dashboard/admin/workflow/nodeOption/user.svg"
...
import { Handle, Position, getConnectedEdges, useReactFlow, Node, MarkerType, getOutgoers } from 'reactflow'
import NodeOptionPopup from '../../nodeOptionPopup/NodeOptionPopup'
import { ContextWorkflow } from '../../../../../../../../contexts/workflowContext'
const IndentificationNode = ({ ...data }) => {
  ...
  return (
    <div className={`${style.node_area} ${style.identityfication} ${(contextWorkflow.selectedNodeForSetting.id == data.id) ? style.recent_node : null}`}>
      ...
      <Handle type="source" position={Position.Bottom} isConnectable={true} style={{ background: 'rgba(178, 193, 231, 1)', cursor: 'pointer' }} ref={optionRef}>
...
export default IndentificationNode